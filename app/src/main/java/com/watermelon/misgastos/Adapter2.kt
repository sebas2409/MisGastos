...
import com.watermelon.misgastos.databinding.ProductoViewHolderBinding

class Adapter2(val productos: ArrayList<Productos>): RecyclerView.Adapter<Adapter2.ViewHolder>() {


    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding2=ProductoViewHolderBinding.inflate(LayoutInflater.from(parent.context),parent,false)
