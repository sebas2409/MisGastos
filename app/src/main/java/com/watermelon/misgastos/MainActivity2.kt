...
import com.watermelon.misgastos.databinding.ActivityMain2Binding
import com.watermelon.misgastos.databinding.AlertDialogBinding
...
class MainActivity2 : AppCompatActivity(){
    ...
    private fun getData() {
        val intent=intent
        val nombre=intent.getStringExtra("nombre")
        database.getReference("Listas").child(nombre.toString()).child("productos").addValueEventListener(object : ValueEventListener{
